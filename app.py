...
# Use MONGO_URI environment variable for MongoDB connection; default to mongodb://localhost:27017/tododb if not set
...
db = client.get_default_database()    #Select the database (database name specified in the URI)
